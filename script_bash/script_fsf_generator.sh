...
TEMPLATE_PATH=/Users/bo/Documents/bash_script/template_activity_glm_lrb_2s_20201228.fsf
...
OUTPUTDIR=$server_root/NAYA$sub/contrast_lrb_2s_20201228_s$session
...
sed -e 's@OUTPUTDIR@'$OUTPUTDIR'@g' \
    ...
    -e 's@ROOTPATH@'$server_root'@g' <$TEMPLATE_PATH> /Users/bo/Documents/bash_script/template_activity_glm_lrb_2s_20201228/fsf_sub$sub"_s"$session".fsf"
