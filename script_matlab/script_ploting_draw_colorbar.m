...
%% vertical 
input_path = '/Users/bo/Documents/data_yuji_lab/data_fmri/analysis_contrast_direction_old/MRI_contrast_corr/tval_corrected_left_back.nii';
h1 = MRIread(input_path);
value_list = h1.vol;
...
%% vertical 
input_path = '/Users/bo/Documents/data_yuji_lab/data_fmri/analysis_contrast_direction/ROIs20210106/tval_con_parietal_z_r_map_b_lr.nii';
h1 = MRIread(input_path);
value_list = h1.vol;
value_list(find(value_list==0))=[];
